...
namespace csc370_homework1
{
	...
	public:
		static std::wstring encode(const std::wstring &original);

		virtual int countChar(const std::wstring &str, wchar_t c);
...
int main(int argc, char **argv)
{
	...
	csc370_homework1::CSC370_Homework1::main(args);
}
